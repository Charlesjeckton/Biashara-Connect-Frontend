    ...
    topListings: [
        {
            ...
            contacts: 12,
            performance: 'high',
            image: 'https://images.unsplash.com/photo-1632661674596-df8be070a6c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'
        },
        {
            id: 2,
            ...
            contacts: 8,
            performance: 'high',
            image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'
        },
        {
            id: 3,
            ...
            contacts: 5,
            performance: 'medium',
            image: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'
        },
        {
            id: 4,
            ...
            contacts: 3,
            performance: 'medium',
            image: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'
        },
        {
            id: 5,
            ...
            contacts: 2,
            performance: 'low',
            image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'
        }
    ]
};
        ...
        <tr>
            <td>
                <div class="listing-item">
                    <img src="${listing.image}" alt="${listing.title}" class="listing-image" width="64" height="48" onerror="this.src='https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&h=48&q=100&fit=crop&crop=center'" style="image-rendering: crisp-edges;">
